...
-->
	...
	<xsl:template match="xml">
		...
		<style>
			...
			.Wireframe04 .col0 .section, .Wireframe08 .col2 > div > div:first-child { float:right; }
			.Wireframe04 .col1 .calloutOption, .Wireframe04 .col1 .textOption { height:79px }
			.Wireframe04 .col1 .callout div { top:4px }
			.Wireframe04 .col0 .text div { width:151px; left:9px; background-position-x:-9px }
			.Wireframe04 .col1 .text div { height:55px; top:11px; width:112px; left:9px }
			.Wireframe04 .col1 .fpCarosel div { width:79px; left:26px; background-position:-25px 0; }
			.Wireframe04 .col1 #layoutsection4.text { height:80px }
			.Wireframe07 .col0 > div:last-child { display:none }

			.Wireframe04 #layoutsection5, .Wireframe04 #layoutsection6 { height:82.5px; }

			html .Wireframe08 { height: 490px !important; }
			html .Wireframe08 .col2 > div {
			...
			html .Wireframe08 .col2 > div:nth-child(2) {
			}

			html .Wireframe08 .col1 {
			width:60%;
			float:left;
			padding-top:4px;
			height: 220px;
			...
			html .Wireframe08 .col2 {
			width:38%;
			float:left;
			height: 220px;
			}

			.Wireframe08 .col1 #layoutsection4 { margin-top:4px; }
			.Wireframe08 .col0 > div > div:first-child, .Wireframe08 .col1 > div > div:first-child, .col1 > div > div:first-child, .col1 > div > div:first-child { width: 130px !important; }
			.Wireframe08 .col1 #layoutsection3, .Wireframe08 .col1 #layoutsection4 {width:243px !important;}
			.Wireframe08 .col2 #layoutsection5 {width:123px !important; height: 136px !important;}
			html .Wireframe08 .col2 > div {width: 245px !important;}
			.Wireframe09 .quickSearchPhotoOption .moduleTypeOption:nth-child(2) {display: none;}
		</style>
		...
		<script>
			...
			toolbar2: "preview | insertfile undo redo | cut copy paste | table | hr pagebreak searchreplace | blockquote charmap visualchars anchor nonbreaking media | link | code | styleselect paragraph | imagelibrary",
			...
			function updateSection(node, key, section, className, element, value) {
				...
				if (key == 'WireframeFeaturedPropertiesCarouselModule') {
					...
					$.ajax({
						url: '/modules/intranet/SiteBuilder/FeaturedPropertiesToolProcessingPage.aspx',
						data: data,
						success: onFPCarouselSuccess,
						type: 'GET'
					});
				} else {
			...
			var savedPagesHtml ='';
			var varHeight = 115;
			var customContentHtml = '&lt;tr class="ui-widget-sb-text">&lt;td>&lt;input type="button" onclick="closeOverlay();getCustomText(\'' + id + '\', ' + index + ',\'' + module + '\',\'' + data + '\');"\
			value="Create/Edit My Own Content" class="button ui-widget-sb-text-button" />&lt;/td>&lt;td align="left">Enter your own custom content for this text area.&lt;/td>&lt;/tr>';

			if(parseInt(response) > 0 ) {
			settingsLinkObj = obj;
			varHeight += 125;
			savedPagesHtml = '&lt;tr class="ui-widget-sb-text">&lt;td style="border-right: 1px dotted #000">&lt;input type="button" onclick="closeOverlay();getCustomSavedText(\'' + id + '\', ' + index + ',\'' + module + '\',\'' + data + '\');"\
			value="Choose from My Existing Content" class="button ui-widget-sb-text-button" />&lt;/td>&lt;td align="left">Select your existing content for this text area.&lt;/td>&lt;/tr>';
			}

			var companyContentHtml = '&lt;tr class="ui-widget-sb-text">&lt;td>&lt;input type="button"  onclick="closeOverlay();getCompanyContent(\'' + id + '\', ' + index + ',\'' + module + '\',\'' + data + '\');"\
			value="Choose from Company Content" class="button ui-widget-sb-text-button" />&lt;/td>&lt;td align="left">Select existing, uneditable company content for this text area.&lt;/td>&lt;/tr>';
			...
			if ($('.Wireframe08').length) {
			$('.col2').append('<div style="position:relative; margin-top: 1px;">
				' + '<div class="socialmedia">'+ '</div>' + '<div class="layoutsection5" style="width: 123px; border: 2px solid black; height: 67px;">
					' + '<div>
						' + '<p style="font-weight: bold;text-align: center;padding-top: 3px;">Social Media</p>' + '
					</div>' + '
				</div>' + '
			</div>');
			}
		...
		<form id="frmWireframe" action="processwireframe.aspx">
			...
			<xsl:if test="count(websiteConfigurationOptions/skinOptions/skin) > 1">
				<h2>Skins</h2>
			...
			<h2><xsl:value-of select="SkinSectionTitle"/></h2>
			<div class="crm-page-section-row">
				<div class="crm-page-section-column full">
			...
			<div>
				...
				<h2>Customize Your <xsl:value-of select="$LayoutOrWireframe"/></h2>
				<div class="crm-page-section-row">
					<div class="crm-page-section-column full">
	...
	<xsl:template match="websiteConfigurationOptions/skinOptions/skin">
		...
		<a class="crm-site-builder-toggle{$selected}" onmouseover="toggleHover(this)" onmouseout="toggleHover(this)" onclick="updateOption(this, 'skin', '{name}')">
	...
	<xsl:template match="websiteConfigurationOptions/wireframeOptions/wireframe">
		...
		<a id="div{key}" class="crm-site-builder-toggle{$selected}" onmouseover="toggleHover(this)" onmouseout="toggleHover(this)" onclick="updateWireframe(this, 'wireframe', '{key}');">
			<xsl:value-of select="label"/>
		</a>
	</xsl:template>
	...
	<xsl:template match="websiteConfigurationOptions/otherCalloutOptions/callout">
		...
		<a class="crm-site-builder-toggle{$selected}" onmouseover="toggleHover(this)" onmouseout="toggleHover(this)" onclick="updateOption(this, 'callout', '{node()}')">
